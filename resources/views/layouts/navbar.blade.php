    ...
    <div class="flex items-center justify-between max-w-screen-xl px-4 mx-auto">
        ...
        <div class="hidden lg:flex space-x-8 ml-10">
            <ul class="flex space-x-8">
                ...
                <li><a href="#" class="text-white hover:text-gray-200 bg-transparent font-medium rounded-lg text-[15px] px-4 py-2">Company</a></li>
                <li><a href="#" class="text-white hover:text-gray-200 bg-transparent font-medium rounded-lg text-[15px] px-4 py-2">Marketplace</a></li>
                <li><a href="#" class="text-white hover:text-gray-200 bg-transparent font-medium rounded-lg text-[15px] px-4 py-2">Features</a></li>
                <li><a href="#" class="text-white hover:text-gray-200 bg-transparent font-medium rounded-lg text-[15px] px-4 py-2">Team</a></li>
                <li><a href="#" class="text-white hover:text-gray-200 bg-transparent font-medium rounded-lg text-[15px] px-4 py-2">Contact</a></li>
            </ul>
        </div>
