<nav class="bg-#eb0029 border-gray-200 py-2.5">
    <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
        <a href="#" class="flex z-10">
            <img src="img/banorte.png" class="h-10 md:h-12 rounded-full" alt="Landwind Logo" h>

            <a href="https://themesberg.com/product/tailwind-css/landing-page"
            class="text-white bg-redsito hover:bg-redsitoHov focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 focus:outline-none">Login</a>
